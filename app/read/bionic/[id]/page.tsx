        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-card rounded-lg border p-6">
            {isGoogleDrivePdf && driveFileId ? (
              <div>
                <h2 className="text-xl font-semibold mb-4 text-center">Bionic Okuma Modu</h2>
                <p className="text-muted-foreground mb-6 text-center">
                  Google Drive'dan yüklenen PDF. Bionic okuma deneyimi yakında eklenecek.
                </p>
              ...
              <div className="text-center">
                <h2 className="text-xl font-semibold mb-4">Bionic Okuma Modu</h2>
                <p className="text-muted-foreground mb-6">
                  Kullanıcı PDF'i yüklendi. Bionic okuma deneyimi yakında eklenecek.
                </p>
